...
public class BrowserUtility { //Made concrete so it can be instantiated from tests
	...
	public BrowserUtility(Browser browserName, boolean isHeadless) {
		...
		if(browserName==Browser.CHROME) {
			...
			// In some environments giving an explicit user-data-dir avoids DevToolsActivePort errors
			// Use a temp directory (unique per run) to avoid collisions/locks
			String userDir = System.getProperty("java.io.tmpdir") + File.separator + "chrome-profile-" + System.nanoTime();
	...
	public String takeScreenShot(String name) {
		//TakesScreenshot screenshot = (TakesScreenshot)driver; //Casting WebD instance to TakesScreenshot
